...
char_map = dict(
    ...
    o='octahedron_lower',
    O='octahedron_upper',
    z='trapezohedron_lower',
    Z='trapezohedron_upper',
    d='dodecahedron_lower',
    D='dodecahedron_upper',
    i='icosahedron_lower',
    I='icosahedron_upper',
    w='trapezohedra_lower',
    W='trapezohedra_upper'
)
...
def main(args=None):
    ...
    fnt_lines.append('page id=0 file="dice_font_{}.png"'.format(tile_size))
    ...
    png_name = os.path.join(args.output_dir, 'dice_font_{}.png'.format(tile_size))
    fnt_name = os.path.join(args.output_dir, 'dice_font_{}.fnt'.format(tile_size))
